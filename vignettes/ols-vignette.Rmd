...
We can see that only the first and fourth $\hat{\beta}$ estimates have confidence interval intervals that do not include a zero. Therefore, we can the claim that the weight of a car has a significant negative effect on the outcome of interest by a magnitude of approximately -3.18
...
We see that our implemented function runs faster than the ```lm()```. This is mostly because


## Analysis on Larger Dataset

We simulate a larger dataset and compare the speed
